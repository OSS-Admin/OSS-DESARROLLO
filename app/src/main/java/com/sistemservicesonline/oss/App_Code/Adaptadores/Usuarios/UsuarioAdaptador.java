package com.sistemservicesonline.oss.App_Code.Adaptadores.Usuarios;
...
public class UsuarioAdaptador extends RecyclerView.Adapter<UsuarioAdaptador.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        viewHolder.TextViewNombreUsuario.setText(LstUsuarios.get(i).getsNombreCompleto());
        viewHolder.TextViewPerfilProfesional.setText(LstUsuarios.get(i).getsProfesion());
    }
